package cn.com.jcs.leetCode.problem929.uniqueEmailAddresses;
...
public class Solution {
	public int numUniqueEmails(String[] emails) {
		...
		for (String email : emails) {
			...
			String[] splitWithAdd = splitEmail[0].split("\\+");
			String re = splitWithAdd[0].replaceAll("\\.", "");
			emailSet.add(re + "@" +splitEmail[1]);
		}
